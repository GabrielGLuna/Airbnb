...
const ConversationDetail: React.FC<ConversationDetailProps> = ({
    ...
    const { sendJsonMessage, lastJsonMessage, readyState } = useWebSocket(`${process.env.NEXT_PUBLIC_API_HOST}/ws/${conversation.id}/?token=${token}`,
        {
            share: false,
    ...
    useEffect(() => {
        if (lastJsonMessage && typeof lastJsonMessage === 'object' && 'name' in lastJsonMessage && 'body' in lastJsonMessage) {
            const message: MessageType = {
                ...
                set_to_id: otherUser as UserType,
    ...
    const sendMessage = async () => {
        ...
        console.log('jrje', process.env.NEXT_PUBLIC_API_HOST);
